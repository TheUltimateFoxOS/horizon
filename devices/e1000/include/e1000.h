...
namespace driver {
	class e1000_driver: public driver::device_driver, public interrupts::interrupt_handler, public driver::nic_device {
		...
		public:
			...
			e1000_driver(pci::pci_header_0_t* header, uint16_t bus, uint16_t device, uint16_t function);
			~e1000_driver();
